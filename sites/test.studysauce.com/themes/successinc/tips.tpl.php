...
<div class="grid_6">
    ...
    <div><img width="48" height="48" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20Location%202.png">
        <h4>Alternating study location</h4>
        <p>Changing location has shown a significant improvement in memory retention in studies done by cognitive scientists.&nbsp; According to the researchers, the brain associates the material being learned with the environment that the studier is in.&nbsp; Varied environments allow the brain more opportunities to associate the material with something unique - which in turn increases the likelihood of retention.<!--<a onclick="jQuery(this).parent().parent().toggleClass('read-more'); return false;" href="#">Read more</a></p>
<p class="read-more">The three pillars of learning; seeing much, suffering much, and studying much. (Welsh triad; later attributed to Benjamin Disraeli)</p>--></p>
    </div>
    <div><img width="64" height="64" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20Multitopic.png">
        <h4>Studying multiple subjects during the same session</h4>
    ...
    <div><img width="64" height="64" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20No%20Phone.png">
        <h4>Ditching the cell phone</h4>
        <p>Your cell phone is your enemy when it comes to studying.&nbsp; If you are like us, severing your electronic umbilical cord is extraordinarily tough to do.&nbsp; If you have a smartphone, put it on airplane mode in order to avoid any distractions.&nbsp; The texts and calls can wait…promise.&nbsp; This obviously goes for tablets, ipods, kindles, laptops, and anything else that will draw your attention away from the task at hand.</p>
    </div>
    <div><img width="64" height="64" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20Take%20Breaks.png">
        <h4>Taking breaks</h4>
        <p>This will ultimately be a personal preference.&nbsp; A good rule of thumb is to study hard for 50 minutes, then take a 10 minute break.&nbsp; You can then repeat the process for days that you need to study longer.&nbsp; There is a lot of conflicting research in this area, so try to experiment and find what works best for you.&nbsp; One interesting study concluded that students that took nature walk breaks outperformed students that took walks in an urban setting.&nbsp; If you have access to a nature walk, give it a shot.</p>
    </div>
    <div><img width="64" height="64" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20Positive.png">
...
<div class="grid_6">
    <h3>Bad study habits</h3>
    <div><img width="64" height="64" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20Underline.png">
    ...
    <div><img width="64" height="64" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20Multitask.png">
        <h4>Multitasking</h4>
    ...
    <div><img width="64" height="64" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20No%20Music.png">
    ...
    <div><img width="64" height="64" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20Cramming.png">
        <h4>Cramming</h4>
        <p>Cramming does tend to produce short term results, however, the brain has a tendency to immediately “dump” the information shortly after the test.&nbsp; You will end up having to restudy the material to commit it to long term memory…which can be problematic for your Final Exams…&nbsp; Not to mention the fact that the material you are studying will most likely need to be used again in a more advanced course.</p>
    </div>
    <div><img width="64" height="64" src="/<?php print drupal_get_path('theme', 'successinc'); ?>/images/Ico%20bed.png">
        <h4>Studying in bed</h4>
        <p>When studying, you want to put your body into a receptive mode that is conducive to learning and retention.&nbsp; Getting too comfortable can be counterproductive and can make you drowsy while good posture can help you maintain alertness and enable you to study longer and more effectively.</p>
    </div>
    <p>&nbsp;</p>
    <div class="highlighted-link" style="text-align:center;">
        <p><a class="more" href="/buy">Buy study plan</a></p>
        <p><a class="more-parents students_only" href="/student/1">Bill my parents</a></p></div>
</div>
