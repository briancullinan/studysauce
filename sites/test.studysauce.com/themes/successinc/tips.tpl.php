<div id="study-quiz">
    <div>
        ...
        <a href="#" onclick="jQuery('#tips').removeClass('study-quiz-only').scrollintoview(); return false;" class="fancy-close">&nbsp;</a>
    </div>
</div>
<h2 class="highlighted-link">Top 10 study tips <a href="#study-quiz" class="more" style="float:right;">Take the study quiz</a></h2>
<div class="grid_6">
    <h3>Good study habits</h3>
    <div><img width="48" height="48" src="/[custom:theme-path]/images/Ico%20Location%202.png">
...
<p class="read-more">The three pillars of learning; seeing much, suffering much, and studying much. (Welsh triad; later attributed to Benjamin Disraeli)</p>--></p>
    ...
    <div><img width="64" height="64" src="/[custom:theme-path]/images/Ico%20Multitopic.png">
    ...
    <div><img width="64" height="64" src="/[custom:theme-path]/images/Ico%20No%20Phone.png">
    ...
    <div><img width="64" height="64" src="/[custom:theme-path]/images/Ico%20Take%20Breaks.png">
        <h4>Taking breaks</h4>
    ...
    <div><img width="64" height="64" src="/[custom:theme-path]/images/Ico%20Positive.png">
...
<div class="grid_6">
    ...
    <div><img width="64" height="64" src="/[custom:theme-path]/images/Ico%20Underline.png">
    ...
    <div><img width="64" height="64" src="/[custom:theme-path]/images/Ico%20Multitask.png">
        <h4>Multitasking</h4>
    ...
    <div><img width="64" height="64" src="/[custom:theme-path]/images/Ico%20No%20Music.png">
    ...
    <div><img width="64" height="64" src="/[custom:theme-path]/images/Ico%20Cramming.png">
        <h4>Cramming</h4>
    ...
    <div><img width="64" height="64" src="/[custom:theme-path]/images/Ico%20bed.png">
