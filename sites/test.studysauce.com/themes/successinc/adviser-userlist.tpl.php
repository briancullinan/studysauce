...
?>
    ...
    <table>
        ...
        foreach ($accessed as $i => $a) {
            ...
            if (count($adviserGroups) > 1) :?>
                <td><?php print (isset($m->otherAdviser) && isset($m->otherAdviser->field_first_name['und'][0]['value']) ? ($m->otherAdviser->field_first_name['und'][0]['value'] . ' ' . $m->otherAdviser->field_last_name['und'][0]['value']) : 'You'); ?></td><?php endif;
            print '</tr>';
        }
