    ...
    { ?>
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                jQuery('#sds-messages .<?php print $last; ?>').addClass('show');
            });
        </script>
    <?php } ?>
</div>
...
if(empty($classes)):
    ...
    <div class="parents_only">
        <h2><span>Only students can access this information.</span></h2>
    </div>
<?php endif; ?>
...
<div id="mozart-effect">
    <div>
        ...
        <p style="margin-bottom:0;">
            <a href="http://www.mozarteffect.com/index.html" target="_blank">Dan Campbell's proprietary Mozart Effect&reg;</a><br />
